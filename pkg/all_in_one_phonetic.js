 ...
 * @returns {any}
 */
export function ConvertMain(req_js) {
    const ret = wasm.ConvertMain(req_js);
    if (ret[2]) {
...
function __wbg_adapter_67(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures__invoke0_mut__hbfea98b2e928e8b6(arg0, arg1);
}

function __wbg_adapter_111(arg0, arg1, arg2, arg3, arg4) {
    wasm.closure87_externref_shim(arg0, arg1, arg2, arg3, arg4);
}
...
const RequestDataFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_requestdata_free(ptr >>> 0, 1));
...
export class RequestData {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        RequestDataFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_requestdata_free(ptr, 0);
    }
}

const ResponseDataFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_responsedata_free(ptr >>> 0, 1));
...
export class ResponseData {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ResponseDataFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_responsedata_free(ptr, 0);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_wbgtestinvoke_d8e1edfc10304da7 = function() { return handleError(function (arg0, arg1) {
        try {
            ...
            var cb0 = () => {
                ...
                state0.a = 0;
                try {
                    return __wbg_adapter_67(a, state0.b, );
                } finally {
                    state0.a = a;
                }
            };
    ...
    imports.wbg.__wbindgen_closure_wrapper297 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 72, __wbg_adapter_42);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('all_in_one_phonetic_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
